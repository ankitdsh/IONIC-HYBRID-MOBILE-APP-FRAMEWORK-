...
(function() {
    ...
    function r(n) {
        return function(r, t, e) {
            t = m(t, e);
            for (var u = null != r && r.length, i = n > 0 ? 0 : u - 1; i >= 0 && u > i; i += n)
    ...
    "undefined" != typeof exports ? ("undefined" != typeof module && module.exports && (exports = module.exports = y), exports._ = y) : t._ = y, y.VERSION = "1.8.1";
    var d = function(n, r, t) {
        ...
        m = function(n, r, t) {
            return null == n ? y.identity : y.isFunction(n) ? d(n, r, t) : y.isObject(n) ? y.matcher(n) : y.property(n)
        };
    y.iteratee = function(n, r) {
        return m(n, r, 1 / 0)
    };
    var b = function(n, r) {
            return function(t) {
        ...
        j = function(n) {
            var r = n && n.length;
            return "number" == typeof r && r >= 0 && _ >= r
        };
    y.each = y.forEach = function(n, r, t) {
        ...
        r = m(r, t);
        for (var e = !j(n) && y.keys(n), u = (e || n).length, i = Array(u), o = 0; u > o; o++) {
            var a = e ? e[o] : o;
            i[o] = r(n[a], a, n)
        }
        return i
    }, y.reduce = y.foldl = y.inject = n(1), y.reduceRight = y.foldr = n(-1), y.find = y.detect = function(n, r, t) {
        var e;
        return e = j(n) ? y.findIndex(n, r, t) : y.findKey(n, r, t), e !== void 0 && e !== -1 ? n[e] : void 0
        ...
        r = m(r, t);
        for (var e = !j(n) && y.keys(n), u = (e || n).length, i = 0; u > i; i++) {
            var o = e ? e[i] : i;
        ...
        return !1
    }, y.contains = y.includes = y.include = function(n, r) {
        return j(n) || (n = y.values(n)), y.indexOf(n, r) >= 0
        ...
        if (null == r && null != n) {
            ...
            u = r(n, t, e), (u > o || u === -1 / 0 && i === -1 / 0) && (i = n, o = u)
        });
        return i
        ...
        for (var r, t = j(n) ? n : y.values(n), e = t.length, u = Array(e), i = 0; e > i; i++) r = y.random(0, i), r !== i && (u[i] = u[r]), u[r] = t[i];
        return u
    }, y.sample = function(n, r, t) {
        return null == r || t ? (j(n) || (n = y.values(n)), n[y.random(n.length - 1)]) : y.shuffle(n).slice(0, Math.max(0, r))
    }, y.sortBy = function(n, r, t) {
        return r = m(r, t), y.pluck(y.map(n, function(n, t, e) {
            return {
                value: n,
                index: t,
                criteria: r(n, t, e)
    ...
    var w = function(n) {
        return function(r, t, e) {
            var u = {};
            return t = m(t, e), y.each(r, function(e, i) {
                var o = t(e, i, r);
                n(u, e, o)
            }), u
        }
    };
    y.groupBy = w(function(n, r, t) {
        y.has(n, t) ? n[t].push(r) : n[t] = [r]
    }), y.indexBy = w(function(n, r, t) {
        n[t] = r
    }), y.countBy = w(function(n, r, t) {
        y.has(n, t) ? n[t] ++ : n[t] = 1
    }), y.toArray = function(n) {
        return n ? y.isArray(n) ? c.call(n) : j(n) ? y.map(n, y.identity) : y.values(n) : []
    }, y.size = function(n) {
        return null == n ? 0 : j(n) ? n.length : y.keys(n).length
    }, y.partition = function(n, r, t) {
        r = m(r, t);
        var e = [],
            u = [];
        return y.each(n, function(n, t, i) {
            (r(n, t, i) ? e : u).push(n)
        }), [e, u]
    }, y.first = y.head = y.take = function(n, r, t) {
        return null == n ? void 0 : null == r || t ? n[0] : y.initial(n, n.length - r)
    }, y.initial = function(n, r, t) {
        return c.call(n, 0, Math.max(0, n.length - (null == r || t ? 1 : r)))
    }, y.last = function(n, r, t) {
        return null == n ? void 0 : null == r || t ? n[n.length - 1] : y.rest(n, Math.max(0, n.length - r))
    }, y.rest = y.tail = y.drop = function(n, r, t) {
        return c.call(n, null == r || t ? 1 : r)
    }, y.compact = function(n) {
        return y.filter(n, y.identity)
    };
    var A = function(n, r, t, e) {
        for (var u = [], i = 0, o = e || 0, a = n && n.length; a > o; o++) {
            var c = n[o];
            if (j(c) && (y.isArray(c) || y.isArguments(c))) {
                r || (c = A(c, r, t));
                var l = 0,
                    f = c.length;
    ...
    y.flatten = function(n, r) {
        ...
        for (var u = [], i = [], o = 0, a = n.length; a > o; o++) {
            var c = n[o],
                l = t ? t(c, o, n) : c;
            r ? (o && i === l || u.push(c), i = l) : t ? y.contains(i, l) || (i.push(l), u.push(c)) : y.contains(u, c) || u.push(c)
        }
        return u
    }, y.union = function() {
        ...
        for (var r = [], t = arguments.length, e = 0, u = n.length; u > e; e++) {
            var i = n[e];
            if (!y.contains(r, i)) {
                for (var o = 1; t > o && y.contains(arguments[o], i); o++);
                o === t && r.push(i)
            }
        }
        return r
        ...
        for (var r = n && y.max(n, "length").length || 0, t = Array(r), e = 0; r > e; e++) t[e] = y.pluck(n, e);
        return t
    }, y.object = function(n, r) {
        for (var t = {}, e = 0, u = n && n.length; u > e; e++) r ? t[n[e]] = r[e] : t[n[e][0]] = n[e][1];
        return t
    }, y.indexOf = function(n, r, t) {
        var e = 0,
            u = n && n.length;
        if ("number" == typeof t) e = 0 > t ? Math.max(0, u + t) : t;
        else if (t && u) return e = y.sortedIndex(n, r), n[e] === r ? e : -1;
        if (r !== r) return y.findIndex(c.call(n, e), y.isNaN);
        for (; u > e; e++)
            if (n[e] === r) return e;
        return -1
    }, y.lastIndexOf = function(n, r, t) {
        var e = n ? n.length : 0;
        if ("number" == typeof t && (e = 0 > t ? e + t + 1 : Math.min(e, t + 1)), r !== r) return y.findLastIndex(c.call(n, 0, e), y.isNaN);
        for (; --e >= 0;)
            if (n[e] === r) return e;
        return -1
    }, y.findIndex = r(1), y.findLastIndex = r(-1), y.sortedIndex = function(n, r, t, e) {
        t = m(t, e, 1);
        for (var u = t(r), i = 0, o = n.length; o > i;) {
    ...
    y.bind = function(n, r) {
        ...
        var t = c.call(arguments, 2),
            e = function() {
                return k(n, e, r, this, t.concat(c.call(arguments)))
            };
        return e
    }, y.partial = function(n) {
        var r = c.call(arguments, 1),
            t = function() {
                for (var e = 0, u = r.length, i = Array(u), o = 0; u > o; o++) i[o] = r[o] === y ? arguments[e++] : r[o];
                for (; e < arguments.length;) i.push(arguments[e++]);
                return k(n, t, this, this, i)
            };
        return t
    }, y.bindAll = function(n) {
        var r, t, e = arguments.length;
        if (1 >= e) throw new Error("bindAll must be passed function names");
        for (r = 1; e > r; r++) t = arguments[r], n[t] = y.bind(n[t], n);
        return n
        ...
        t || (t = {});
        var c = function() {
            a = t.leading === !1 ? 0 : y.now(), o = null, i = n.apply(e, u), o || (e = u = null)
        };
        return function() {
            var l = y.now();
            a || t.leading !== !1 || (a = l);
    ...
    }, y.once = y.partial(y.before, 2), y.keys = function(n) {
        if (!y.isObject(n)) return [];
        if (p) return p(n);
        var r = [];
        ...
        for (var r = y.keys(n), t = r.length, e = Array(t), u = 0; t > u; u++) e[u] = n[r[u]];
        return e
    }, y.mapObject = function(n, r, t) {
        r = m(r, t);
        for (var e, u = y.keys(n), i = u.length, o = {}, a = 0; i > a; a++) e = u[a], o[e] = r(n[e], e, n);
        return o
    }, y.pairs = function(n) {
        for (var r = y.keys(n), t = r.length, e = Array(t), u = 0; t > u; u++) e[u] = [r[u], n[r[u]]];
        return e
    }, y.invert = function(n) {
        for (var r = {}, t = y.keys(n), e = 0, u = t.length; u > e; e++) r[n[t[e]]] = t[e];
        return r
    }, y.functions = y.methods = function(n) {
        var r = [];
        for (var t in n) y.isFunction(n[t]) && r.push(t);
        return r.sort()
    }, y.extend = b(y.allKeys), y.extendOwn = b(y.keys), y.findKey = function(n, r, t) {
        r = m(r, t);
        for (var e, u = y.keys(n), i = 0, o = u.length; o > i; i++)
            if (e = u[i], r(n[e], e, n)) return e
    }, y.pick = function(n, r, t) {
        var e, u = {};
        if (null == n) return u;
        if (y.isFunction(r)) {
            r = d(r, t);
            for (var i = y.allKeys(n), o = 0; o < i.length; o++) {
                var e = i[o],
                    a = n[e];
                r(a, e, n) && (u[e] = a)
            }
        } else {
            var i = A(arguments, !1, !1, 1);
            n = new Object(n);
            for (var o = 0, c = i.length; c > o; o++) e = i[o], e in n && (u[e] = n[e])
        }
        return u
    }, y.omit = function(n, r, t) {
        if (y.isFunction(r)) r = y.negate(r);
        else {
            var e = y.map(A(arguments, !1, !1, 1), String);
            r = function(n, r) {
                return !y.contains(e, r)
            }
        }
        return y.pick(n, r, t)
    }, y.defaults = b(y.allKeys, !0), y.clone = function(n) {
    ...
    var O = function(n, r, t, e) {
        ...
        if (!i) {
            ...
            var o = n.constructor,
                a = r.constructor;
            if (o !== a && !(y.isFunction(o) && o instanceof o && y.isFunction(a) && a instanceof a) && "constructor" in n && "constructor" in r) return !1
        }
        t = t || [], e = e || [];
        ...
        if (t.push(n), e.push(r), i) {
            ...
            for (; c--;)
                if (!O(n[c], r[c], t, e)) return !1
        } else {
            var f, s = y.keys(n);
            if (c = s.length, y.keys(r).length !== c) return !1;
            for (; c--;)
                if (f = s[c], !y.has(r, f) || !O(n[f], r[f], t, e)) return !1
        }
    ...
    y.isEqual = function(n, r) {
        ...
        return null == n ? !0 : j(n) && (y.isArray(n) || y.isString(n) || y.isArguments(n)) ? 0 === n.length : 0 === y.keys(n).length
    ...
    }), "function" != typeof / . / && "object" != typeof Int8Array && (y.isFunction = function(n) {
    ...
    y.escape = N(F), y.unescape = N(M), y.result = function(n, r, t) {
        var e = null == n ? void 0 : n[r];
        return e === void 0 && (e = t), y.isFunction(e) ? e.call(n) : e
    };
    var E = 0;
    ...
    y.template = function(n, r, t) {
        ...
        var e = RegExp([(r.escape || S).source, (r.interpolate || S).source, (r.evaluate || S).source].join("|") + "|$", "g"),
            u = 0,
            i = "__p+='";
        n.replace(e, function(r, t, e, o, a) {
            return i += n.slice(u, a).replace(B, T), u = a + r.length, t ? i += "'+\n((__t=(" + t + "))==null?'':_.escape(__t))+\n'" : e ? i += "'+\n((__t=(" + e + "))==null?'':__t)+\n'" : o && (i += "';\n" + o + "\n__p+='"), r
    ...
    y.mixin = function(n) {
        y.each(y.functions(n), function(r) {
            ...
            y.prototype[r] = function() {
                var n = [this._wrapped];
                return a.apply(n, arguments), R(this, t.apply(y, n))
            }
        })
        ...
        y.prototype[n] = function() {
            var t = this._wrapped;
            return r.apply(t, arguments), "shift" !== n && "splice" !== n || 0 !== t.length || delete t[0], R(this, t)
        }
